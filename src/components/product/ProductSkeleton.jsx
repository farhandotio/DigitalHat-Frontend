...
const ProductSkeleton = () => (
  <div className="w-full bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden animate-pulse">
    <div className="p-4 flex items-center justify-center h-48 bg-gray-200 relative">
      <div className="absolute top-4 left-4 w-12 h-5 bg-gray-300 rounded-full"></div>
    ...
    <div className="p-4 flex flex-col">
      ...
      <div className="w-full py-4 bg-gray-300 rounded-lg"></div>
    </div>
  </div>
);
